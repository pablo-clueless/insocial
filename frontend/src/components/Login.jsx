            ...
            <div className='absolute flex flex-col justify-center items-center top-0 left-0 right-0 bottom-0 bg-blackOverlay'>
                ...
                <div className='shadow-2xl'>
                    <GoogleLogin clientId={client_id} render={(renderProps) => (
                        <button type='button' className='bg-mainColor flex justify-center items-center p-3 m-5 rounded-lg cursor-pointer font-medium text-xl duration-300 ease-in-out outline-none hover:scale-110' onClick={renderProps.onClick} disabled={renderProps.disabled} >
